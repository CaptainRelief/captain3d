...
const io = socketIO(httpsServer, {
    cors: {
        origin: 'https://captainrelief.github.io/captain3d/index.html', // Replace with your frontend's URL
        methods: ["GET", "POST"],
        credentials: true,
...
const corsOptions = {
    origin: 'https://captainrelief.github.io/captain3d/index.html', // Replace with your Nginx server's domain or IP
